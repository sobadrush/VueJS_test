    ...
    <div class="layout-container">
      ...
      <aside class="sidebar-container">
        <div class="sidebar-header">
          <div class="pull-right pt-lg text-muted hidden"><em class="ion-close-round"></em></div><a href="#" class="sidebar-header-logo"><img src="../static/assets/img/logo.png" data-svg-replace="assets/img/logo.svg" alt="Logo"><span class="sidebar-header-logo-text">Centric</span></a>
        </div>
        <div class="sidebar-content">
          <div class="sidebar-toolbar text-center"><a href=""><img src="../static/assets/img/user/01.jpg" alt="Profile" class="img-circle thumb64"></a>
            ...
            <div class="row">
              <div class="col-lg-8 col-xs-12">
                  ...
                  <div class="col-sm-6 col-xs-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <p class="m0"><a href="#"><img src="../static/assets/img/pic1.jpg" alt="Pic" class="mr-sm thumb48"></a><a href="#"><img src="../static/assets/img/pic2.jpg" alt="Pic" class="mr-sm thumb48"></a><a href="#"><img src="../static/assets/img/pic3.jpg" alt="Pic" class="mr-sm thumb48"></a><a href="#"><img src="../static/assets/img/pic4.jpg" alt="Pic" class="mr-sm thumb48"></a></p>
                      </div>
                ...
                <div class="row">
                  <div class="col-sm-6 col-xs-12">
                    <div class="card">
                      <div class="card-item"><img src="../static/assets/img/pic5.jpg" alt="MaterialImg" class="fw img-responsive">
                ...
                <div class="card bg-success">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-xs-4"><a href="#"><img src="../static/assets/img/user/05.jpg" alt="Image" class="img-responsive img-rounded"></a></div>
                    </div>
                  </div>
